    ...
    * 产品数据: product
    ...
    def ads(self) -> AdsAPI:
        ...
        * 新广告 - 报告
            ...
            - SpQueryKeywordReports: [SP关键词的用户搜索词报表(keyword)](https://apidoc.lingxing.com/#/docs/newAd/report/queryWordReports)
            ...
            - SpQueryTargetReports: [SP商品投放的用户搜索词报表(target)](https://apidoc.lingxing.com/#/docs/newAd/report/queryWordReports)

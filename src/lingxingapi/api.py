    ...
    * 产品数据: product
    ...
    def ads(self) -> AdsAPI:
        ...
        * 新广告 - 报告
            ...
            - SpProductReports: [SP广告报表](https://apidoc.lingxing.com/#/docs/newAd/report/spProductAdReports)
            ...
            - SpKeywordQueryReports: [SP关键词的用户搜索词报表(keyword)](https://apidoc.lingxing.com/#/docs/newAd/report/queryWordReports)
            - SpTargetReports: [SP商品投放报表](https://apidoc.lingxing.com/#/docs/newAd/report/spTargetReports)
            - SpTargetHourData: [SP商品投放小时数据(both_ad_target)](https://apidoc.lingxing.com/#/docs/newAd/report/spTargetHourData)
            - SpTargetQueryReports: [SP商品投放的用户搜索词报表(target)](https://apidoc.lingxing.com/#/docs/newAd/report/queryWordReports)
            ...
            - SbKeywordQueryReports: [SB关键词的用户搜索词报告(keyword)](https://apidoc.lingxing.com/#/docs/newAd/report/hsaQueryWordReports)
            - SbKeywordPlacementReports: [SB关键词-广告位报告](https://apidoc.lingxing.com/#/docs/newAd/report/listHsaKeywordPlacementReport)
            - SbTargetReports: [SB商品投放报告(product)](https://apidoc.lingxing.com/#/docs/newAd/report/listHsaTargetingReport)
            - SbTargetQueryReports: [SB用户搜索词报表(target)](https://apidoc.lingxing.com/#/docs/newAd/report/hsaQueryWordReports)
            - SbTargetingHourData: [SB关键词或商品投放小时数据](https://apidoc.lingxing.com/#/docs/newAd/report/sbTargetHourData)
            ...
            - SdTargetReports: [SD商品投放报表](https://apidoc.lingxing.com/#/docs/newAd/report/sdTargetReports)
            - SdTargetHourData: [SD商品投放小时数据(both_ad_target)](https://apidoc.lingxing.com/#/docs/newAd/report/sdTargetHourData)
            - SdMatchedTargetReports: [SD匹配的商品投放报表](https://apidoc.lingxing.com/#/docs/newAd/report/sdMatchTargetReports)
